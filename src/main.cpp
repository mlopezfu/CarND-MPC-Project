...
*/
          ...
          next_x_vals.resize(ptsx_vector.size());
          next_y_vals.resize(ptsy_vector.size());
          ...
          // Next point
          for (int i = 0; i < ptsx_vector.size(); i++) {
            next_x_vals[i] = ptsx_vector[i];
            next_y_vals[i] = ptsy_vector[i];
          }

          // MPC
          for (unsigned int i = 2; i < x1.size(); i++) {
            if(i%2 == 0){
